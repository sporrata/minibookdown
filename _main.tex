...
\hypersetup{
  pdftitle={Stephanie's Mini Bookdown},
  pdfauthor={Stephanie Porrata},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Stephanie's Mini Bookdown}
...
Here is the introduction to my Mini Bookdown. I have no particular topic to talk about. So lets just start with a list of some characters from \emph{Dune} since I am listening to the book right now.
- Paul Atreides
- Lady Jessica
- Leto I Atreides
- Vladimir Harkonnen
